// sonar-file-size: waive=350 reason=pre-existing legacy compaction module; this mission only re-exports the shared provider-accounting helper and decomposition is out of scope
...
pub use jcode_compaction_core::{
    ...
    compacted_summary_text_block, content_char_count, effective_billed_input_tokens_from_usage,
