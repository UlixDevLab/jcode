...
use super::{
    CurrentMissionBrief, EnvSnapshot, SessionImproveMode, SessionStatus, StoredCompactionState,
...
pub(super) struct SessionJournalMeta {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(super) current_mission_brief: Option<CurrentMissionBrief>,
...
pub(super) fn metadata_requires_snapshot(
    ...
    prev.parent_id != current.parent_id
        ...
        || prev.current_mission_brief != current.current_mission_brief
