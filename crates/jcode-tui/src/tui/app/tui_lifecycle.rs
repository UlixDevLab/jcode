// sonar-file-size: waive=350 reason=pre-existing legacy lifecycle module; this mission adds only consent cleanup wiring and full decomposition is out of scope
...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            remote_available_reasoning_efforts: None,
