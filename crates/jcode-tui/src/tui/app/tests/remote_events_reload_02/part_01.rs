// sonar-file-size: waive=350 reason=pre-existing split TUI test fixture; this mission updates the remote auto-poke toggle regression and further decomposition is out of scope
#[test]
