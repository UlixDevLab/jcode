// sonar-file-size: {"waive":350,"owner":"@jcode-maintainers","ticket":"JCODE-QUALITY-RATCHET","baseline_loc":1930,"max_loc":1930,"expires":"2026-11-30","removal_trigger":"Extract focused reload History test fixtures","reason":"Inherited oversized file changed for the bounded session activity protocol"}
#[test]
