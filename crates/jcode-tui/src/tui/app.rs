// sonar-file-size: {"waive":350,"owner":"@jcode-maintainers","ticket":"jcode-auto-poke-finalization","baseline_loc":2553,"max_loc":2553,"expires":"2026-11-30","removal_trigger":"Extract App state domains into focused modules","reason":"Pre-existing TUI state monolith; finalization metadata remains scoped to its existing scheduler."}
...
#[derive(Debug, Clone)]
pub(crate) struct PendingConsentRequest {
...
pub struct App {
    ...
    /// A server-originated, one-shot approval request for a protected tool call.
    pending_consent_request: Option<PendingConsentRequest>,
