// sonar-file-size: waive=350 reason=pre-existing legacy TUI module; this mission adds only consent state exposure and full decomposition is out of scope
...
pub trait TuiState {
    ...
    /// Server-originated approval request for one protected tool operation.
