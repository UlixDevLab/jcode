// sonar-file-size: {"waive":350,"owner":"@jcode-maintainers","ticket":"JCODE-QUALITY-RATCHET","baseline_loc":402,"max_loc":402,"expires":"2026-11-30","removal_trigger":"Extract protocol test fixtures into focused modules","reason":"Inherited oversized file changed for the bounded session activity protocol"}
#[test]
