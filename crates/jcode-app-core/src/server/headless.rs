// sonar-file-size: {"waive":350,"owner":"jcode-maintainers","ticket":"Jcode-control-plane-policy","baseline_loc":387,"max_loc":387,"expires":"2026-12-01","removal_trigger":"module reaches 350 LOC","reason":"Policy extraction keeps inherited module at or below mission-base LOC."}
...
pub(super) async fn create_headless_session(
    ...
    registry.rebind_working_dir(working_dir.as_deref()).await;
    registry
    ...
    if let Some(runtime) = structural_review_runtime {
        new_agent.set_structural_review_authority(runtime.capability(client_session_id.clone()));
    }
