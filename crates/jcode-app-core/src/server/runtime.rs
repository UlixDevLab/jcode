...
use super::structural_review::StructuralReviewRuntime;
...
impl ServerRuntime {
    pub(super) fn from_server(server: &super::Server) -> Self {
        Self {
            ...
            structural_review_runtime: Arc::clone(&server.structural_review_runtime),
        ...
        let result = {
            let client = async {
                ...
                handle_client(
                    ...
                    Arc::clone(&self.structural_review_runtime),
                )
                .await
            };
            tokio::pin!(client);
