...
use super::comm_session::{
    SpawnMetadata, handle_comm_list_models, handle_comm_spawn, handle_comm_stop,
};
use super::comm_sync::{
...
pub(super) struct LightweightControlContext<'a> {
    ...
    pub(super) structural_review_runtime:
        &'a Arc<super::structural_review::StructuralReviewRuntime>,
}
