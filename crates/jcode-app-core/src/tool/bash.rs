...
impl Tool for BashTool {
    ...
    async fn native_consent_requirement(
        ...
        input
            ...
            .and_then(service_consent::native_consent_requirement)
    }
...
impl BashTool {
    ...
    async fn execute_background(&self, params: BashInput, ctx: ToolContext) -> Result<ToolOutput> {
        ...
        // Background commands may legitimately be builds, CI runs, or data
        // migrations that exceed ten minutes. Honor the operator/model's
        // explicit timeout exactly; omitting it remains unlimited.
