// sonar-file-size: {"waive":350,"owner":"@jcode-maintainers","ticket":"JCODE-QUALITY-RATCHET","baseline_loc":1465,"max_loc":1465,"expires":"2026-11-30","removal_trigger":"Continue splitting wire event schemas by concern","reason":"Inherited oversized file changed for the bounded session activity protocol"}
use super::*;
...
pub enum Request {
    ...
    Subscribe {
        ...
        /// Optional launcher capability. Missing values from older clients are
        /// interpreted as ordinary `jcode` by the daemon.
        #[serde(default, skip_serializing_if = "Option::is_none")]
        rlm_client: Option<bool>,
        #[serde(default, skip_serializing_if = "std::ops::Not::not")]
    ...
    CommSpawn {
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        label: Option<String>,
        /// Optional mission binding. Legacy frames omit it and decode as None;
        /// admission is intentionally deferred to the later app-core packet.
        #[serde(default, skip_serializing_if = "Option::is_none")]
        mission_binding: Option<crate::MissionDispatchBinding>,
        /// Optional model-declared dispatch intent. It contains no mission
        /// authority or approval material and is inert until Packet 2.
        #[serde(default, skip_serializing_if = "Option::is_none")]
        dispatch_intent: Option<crate::UntrustedDispatchIntent>,
    },
...
pub enum ServerEvent {
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        activity_context: Option<SessionActivityContextSnapshot>,
