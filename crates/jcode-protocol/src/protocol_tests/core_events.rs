// sonar-file-size: {"waive":350,"owner":"@jcode-maintainers","ticket":"JCODE-QUALITY-RATCHET","baseline_loc":630,"max_loc":630,"expires":"2026-11-30","removal_trigger":"Extract focused protocol event tests","reason":"Inherited oversized file changed for the bounded session activity protocol"}
#[test]
