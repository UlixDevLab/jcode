// sonar-file-size: waive=350 reason=pre-existing e2e support module; P3a updates one subscribe fixture for wire compatibility, and decomposition is out of scope
