// sonar-file-size: waive=350 reason=pre-existing ACP client implementation; P3a propagates explicit launcher identity through subscribe, and decomposition is out of scope
use super::dispatch;
