...
description: >-
  Reflective pass over memory files — merge duplicates, fix stale facts,
  prune the index. Trigger: /consolidate-memory, "consolidate memory",
  memory cleanup, recall dedupe, prune index.
---
